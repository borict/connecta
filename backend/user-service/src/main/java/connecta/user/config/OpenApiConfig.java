...
import connecta.user.exception.ApiErrorResponse;
...
public class OpenApiConfig {
    ...
    OpenAPI userServiceOpenApi() {
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("Connecta User Service")
                        .description("""
                                Auth, profiles and admin user management.
                                Use POST /api/auth/login, copy the token, then Authorize → Bearer token.
                                """)
                        .version("v1"))
